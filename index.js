...
app.get('/hotels/sort/pricing', (req, res) => {
  ...
  if (pricing.toLowerCase() === 'low-to-high')
    hotelsCopy.sort(sortHotelsByPricingInAscendingOrder);
  else if (pricing.toLowerCase() === 'high-to-low')
    hotelsCopy.sort(sortHotelsByPricingInDescendingOrder);
  res.json(hotelsCopy);
});
...
app.get('/hotels/sort/rating', (req, res) => {
  ...
  if (rating.toLowerCase() === 'low-to-high')
    hotelsCopy.sort(sortHotelsByRatingInAscendingOrder);
  else if (rating.toLowerCase() === 'high-to-low')
    hotelsCopy.sort(sortHotelsByRatingInDescendingOrder);
  res.json(hotelsCopy);
});
...
app.get('/hotels/sort/reviews', (req, res) => {
  ...
  let hotelsCopy = hotels.slice();
  if (reviews.toLowerCase() === 'low-to-high')
    hotelsCopy.sort(sortHotelsByReviewsInAscendingOrder);
  else if (reviews.toLowerCase() === 'high-to-low')
    hotelsCopy.sort(sortHotelsByReviewsInDescendingOrder);
  res.json(hotelsCopy);
});
